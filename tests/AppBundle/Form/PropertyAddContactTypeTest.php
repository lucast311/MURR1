...
/**
 * PropertyAddContactTypeTest short summary.
 *
 * PropertyAddContactTypeTest description.
 *
 * @version 1.0
 * @author cst201
 */
class PropertyAddContactTypeTest extends TypeTestCase
{
    /**
    ...
    public function testSubmitData()
    {
        ...
        //create a new form
        $form = $this->factory->create(PropertyAddContactType::class, null,array('contact'=>'1'));
